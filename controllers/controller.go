...
func Start() {
	...
	router.HandleFunc("/api/youtube/", youtube.PutTimerOnVidsTitle).Methods("PUT")

	destiny.GenerateManifest() //router.HandleFunc("/api/destiny/generatemanifest/", destiny.GenerateManifest).Methods("GET")
